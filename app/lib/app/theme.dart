...
class AppTheme {
  ...
  static const _darkBackground = Color(0xFF070B1A);
  static const _darkSurface = Color(0xFF0E1430);
  static const _darkSurfaceHigh = Color(0xFF162040);
  ...
  static ThemeData _build(Brightness brightness) {
    ...
    final scheme = ColorScheme.fromSeed(
      ...
      primary: isDark ? const Color(0xFF4D8DFF) : brand,
      secondary: accent,
      tertiary: gold,
      error: danger,
